...
const ImageAndWelcome = () => (
    <div className="container-fluid">
        <div className="row" style={{ marginBottom: 30 }}>
            <img src={mainImage} width="101%" alt="Aneka Kaca"></img>
        </div>

        <div className="row">
            <div className="col">
                <div className="card text-whdaite bg-success mb-3 text-center">
                    <div className="card-header"><h1>Welcome to Smart Glass Indonesia</h1></div>
